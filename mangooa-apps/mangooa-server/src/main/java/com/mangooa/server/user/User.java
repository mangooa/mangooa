...
public class User extends BaseJpaEntityStringId implements com.mangooa.common.platform.user.User {
	 ...
	 * @return 用户实体对象。
	 */
	static User of(String account, String password, String name, String email, String tenant) {
